...
1. **agentic 多轮 OPD 是硬骨头**：老师 SearchR1-7B 用真实 e5+Wikipedia 检索训出来，学生用 ZeroSearch 模拟搜索后端，**老师对学生轨迹的 logprob 可能因分布偏移而噪声大**，反向 KL 难下降。这是本实验最可能不如预期的地方。兜底方案见 `PLAN.md` §4。
