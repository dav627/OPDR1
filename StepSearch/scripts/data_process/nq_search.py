...
if __name__ == '__main__':
    ...
    train_dataset.to_parquet(os.path.join(local_dir, 'nq_train.parquet'))
    test_dataset.to_parquet(os.path.join(local_dir, 'nq_test.parquet'))
